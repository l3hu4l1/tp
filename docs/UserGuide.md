...
Displays contacts with names containing, or tags matching, any of the given keyword(s).
...
Examples:
* `find syn` displays contacts with names containing `syn`
* `find -t electronics` displays contacts with tags matching `electronics`
* `find /-t` displays contacts with names containing `-t`
...
Displays products with names containing any of the given keyword(s).
...
| **Find Contacts**   | `find [-t] KEYWORD [MORE_KEYWORDS]`                                    | `find TechSource`  <br/>  <br/>                                                                            | Displays contacts with names containing, or tags matching any of the given keyword(s). |
...
| **Find Products**   | `findproduct KEYWORD [MORE_KEYWORDS]`                                                                      | `findproduct uno`                                                           | Displays products with names containing any of the given keyword(s)     |
